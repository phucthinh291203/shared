...
var (
	...
	ErrInvalidCredentials  = status.New(106007, "Invalid email or password").Err()
	ErrNotFound            = status.New(106008, "Not found").Err()
	ErrInvalidToken        = status.New(106009, "Invalid token").Err()
)
